<%-- 
    Document   : add
    Created on : 24.11.2012, 23:26:26
    Author     : Michal Jurc
--%>
...
<html>
    <head>
        ...
        <title><spring:message code="vacation.add.title" /></title>
    ...
    <body>
        ...
        <div id="content">
            <div class="site-width">
                <form:form method="POST" modelAttribute="addedVacation">
                    <fieldset>
                        <legend><h3><spring:message code="vacation.add.header" /></h3></legend>
                        <table>
                            <tr>
                                <td>
