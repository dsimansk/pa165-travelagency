<%-- 
    Document   : edit
    Created on : 25.11.2012, 15:26:51
    Author     : Michal Jurc
--%>
...
<html>
    <head>
        ...
        <title><spring:message code="tour.edit.title" /></title>
    ...
    <body>
        ...
        <div id="content">
            <div class="site-width">
                <form:form method="POST" modelAttribute="editedTour">
                    <fieldset>
                        <legend><h3><spring:message code="tour.edit.header" /></h3></legend>
                        <table>
                            <tr>
                                <td>
